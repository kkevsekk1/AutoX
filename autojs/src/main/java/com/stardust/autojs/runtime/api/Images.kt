...
class Images(
    ...
    private var mPreCapture: Image? = null
    private var mPreCaptureImage: ImageWrapper? = null
    ...
    fun requestScreenCapture(orientation: Int): Boolean {
        ...
        return runBlocking {
            try {
                launch { mScreenCaptureRequester.requestScreenCapture() }.join()
                mScreenCapturer = mScreenCaptureRequester.loadScreenCapture(mContext)
