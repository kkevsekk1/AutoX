 ...
 */
open class EWebViewTBS : FrameLayout, SwipeRefreshLayout.OnRefreshListener, OnActivityResultDelegate {
    ...
    private fun init() {
        inflate(context, R.layout.ewebview_tbs, this)
        ...
        mWebView = findViewById(R.id.web_view_tbs);
