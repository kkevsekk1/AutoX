...
public class CommunityFragment extends ViewPagerFragment implements BackPressedHandler, FloatingActionMenu.OnFloatingActionButtonClickListener {
    ...
    @ViewById(R.id.eweb_view_community)
    ...
    private String mIndexUrl = "http://www.autoxjs.com/";
