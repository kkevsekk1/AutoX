...
import org.autojs.autoxjs.ui.shortcut.ShortcutIconSelectActivity;
...
public class ProjectConfigActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (mNewProject) {
            ...
            mProjectConfig = ProjectConfig.Companion.fromProjectDir(dir);
    ...
    void setupViews() {
        ...
        if (mNewProject) {
            ...
            mMainFileName.setText(mProjectConfig.getMainScript());
    ...
    private void saveProjectConfig() {
        if (mNewProject) {
            ...
            Observable.fromCallable(() -> {
                PFiles.write(ProjectConfig.Companion.configFileOfDir(mDirectory.getPath()),
    ...
    private void syncProjectConfig() {
        ...
        mProjectConfig.setMainScript(mMainFileName.getText().toString());
